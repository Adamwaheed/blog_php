...
<head>
    ...
    <title>Create Category - My Blog</title>
...
<body class="bg-gray-50 font-sans text-gray-800">
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <header class="text-center mb-12">
            ...
            <p class="text-gray-600 text-lg">Add a new category to organize your blog posts</p>
        </header>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form action="../core/category-create.php" method="POST" class="space-y-6">
                <div>
